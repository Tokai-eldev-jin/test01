...
//  }
  ...
  if(digital_filter==1){
    ...
    for(k=0;k<DATA_LEN-50;k=k+50){
      k_cnt1=0;
      for(kk=0;kk<50;kk++){
        if(abs(ADC_table[k+kk]-avedata)<200){
          k_cnt1++;
        }
      }
      if(k_cnt1>20){
    ...
    for(h=0;h<3;h++){//########## フィルタを4回かける
      for(k=0;k<DATA_LEN-52;k=k+2){
        kk=0;
        k_cnt1=0;
        k_flag=0;
...
//        Serial.print(k);
//        Serial.print(',');
//        Serial.print(p_k_cnt1);
//        Serial.print(',');
//        Serial.println(k_cnt1);


        if((p_k_cnt1>=9 && p_k_cnt1<=12) && (k_cnt1>=9 && k_cnt1<=12)){
          for(kk=0;kk<2;kk++){
            ADC_table3[k+kk]=ADC_table[k+kk];
          }
        }else{//########## peakの数がおかしいときは出力を1/30にする
          for(kk=0;kk<2;kk++){
            ADC_table3[k+kk]=(ADC_table[k+kk]-avedata)/30;
...
// HPF 10oder fc=31kHz
    float A10 =  0.4378032684;
    float A11 = -0.8756084442;
    float A12 =  0.4378032684;
    float C11 =  0.0217437744;
    float C12 = -0.7294731140;
                
    float A20 =  0.3482131958;
    float A21 = -0.6964263916;
    float A22 =  0.3482131958;
    float C21 =  0.0172939301;
    float C22 = -0.3755588531;
                
    float A30 =  0.2965850830;
    float A31 = -0.5931701660;
    float A32 =  0.2965850830;
    float C31 =  0.0147304535;
    float C32 = -0.1716117859;
                
    float A40 =  0.2677440643;
    float A41 = -0.5354881287;
    float A42 =  0.2677440643;
    float C41 =  0.0132980347;
    float C42 = -0.0576763153;
                
    float A50 =  0.2547206879;
    float A51 = -0.5094432831;
    float A52 =  0.2547206879;
    float C51 =  0.0126514435;
    float C52 = -0.0062332153;


// BPF Q=0.4 fc=36kHz 
    float A60 =  0.548438885;
    float A61 =  0.0;
    float A62 = -0.548438885;
    float C61 = -0.213587501;
    float C62 =  0.096877771;
/*
...
/*
        ...
        dl_b102 = dl_b101;
*/
        outdata = (add6 * 4  ) + 2048.0;

//if(k<500){
//      Serial.print(k);
//      Serial.print(',');
//      Serial.print(indata,10);
//      Serial.print(',');
//      Serial.print(add1,10);
//      Serial.print(',');
//      Serial.print(add2,10);
//      Serial.print(',');
//      Serial.println(outdata,10);
//}      
